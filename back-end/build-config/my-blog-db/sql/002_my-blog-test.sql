...
*/
INSERT INTO `my-blog`.`users` (`id`,`password`,`name`,`display_name`,`avatar_url`) VALUES (1,'0xABCDEF0123456789','test-user','test-user',NULL);
INSERT INTO `my-blog`.`users` (`id`,`password`,`name`,`display_name`,`avatar_url`) VALUES (2,'0xABCDEF0123456789','test-user-2','test-user-2',NULL);
INSERT INTO `my-blog`.`users` (`id`,`password`,`name`,`display_name`,`avatar_url`) VALUES (3,'0xABCDEF0123456789','test-user-3','test-user-3',NULL);
INSERT INTO `my-blog`.`users` (`id`,`password`,`name`,`display_name`,`avatar_url`) VALUES (4,'0xABCDEF0123456789','test-user-4','test-user-4',NULL);
